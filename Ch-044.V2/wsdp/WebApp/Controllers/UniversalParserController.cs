...
namespace WebApp.Controllers {
	...
	public class UniversalParserController : BaseController {
		...
		public ActionResult Grabber(int? id) {
			...
			HtmlDocument doc = web.Load("http://bt.rozetka.com.ua/microwaves/c80162/filter/32230=39265/");
			var urlList = doc.DocumentNode.SelectNodes("//div[@class='g-i-tile-i-title clearfix']/a/@href").Select(t => t.Attributes.FirstOrDefault(p => p.Name == "href").Value).ToList();
			string localPathToSite;
			int index = 0;
			if (id != null) {
